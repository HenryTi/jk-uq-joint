...
/** */
export const pulls: { read: UqOutConverter, uqIn: UqIn | PullWrite }[] = [
    /*
    { read: readLanguage, uqIn: Language },
    { read: readCountry, uqIn: Country },
    { read: readProvince, usIn: Province },
    { read: readCity, uqIn: City },
    */
    { read: readCounty, uqIn: County },
    /*
    { read: readPackTypeStandard, uqIn: PackTypeStandard },
    { read: readPackType, uqIn: PackTypePullWrite },
    { read: readCurrency, uqIn: Currency },
    { read: readSalesRegion, uqIn: SalesRegion },
