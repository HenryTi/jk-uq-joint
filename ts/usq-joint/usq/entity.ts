...
export abstract class Entity {
    ...
    constructor(entities:Usq, name:string, typeId:number) {
        this.usq = entities;
        this.name = name;
        this.typeId = typeId;
    ...
    protected get tvApi() {return this.usq.openApi;}
    async getApiFrom() {return this.usq.openApi;}
    ...
    public async loadSchema():Promise<void> {
        ...
        let schema = await this.usq.openApi.schema(this.name);
    ...
    public setSchema(schema:any) {
        ...
        this.usq.buildFieldTuid(this.fields = fields);
        this.usq.buildArrFieldsTuid(this.arrFields = arrs, fields);
        this.usq.buildArrFieldsTuid(this.returns = returns, fields);
    ...
    tuidFromField(field:Field):Tuid {
        ...
        return field._tuid = this.usq.getTuid(tuid, undefined);
    }

    tuidFromName(fieldName:string, arrName?:string):Tuid {
        if (this.schema === undefined) return;
        let {fields, arrs} = this.schema;
        let entities = this.usq;
