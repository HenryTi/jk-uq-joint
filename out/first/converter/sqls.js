...
select top 1 ID, CompanyID as WarehouseID, Location as SalesRegionID, minDeliverTime, maxDeliverTime
    ...
    //=========================== Promotion ===========================
    //==============================================================
    readPromotion: `select top 1 MarketingID as ID, Name
    ...
    readPromotionLanguage: `select top 1 ExcID as ID, MarketingID as PromotionID, LanguageID, messageText as Description, Url
        from dbs.dbo.MarketingMessageLanguages where ExcID > @iMaxId order by ExcID`,
    readPromotionPack: `select top 1 ExcID as ID, MarketingID as PromotionID, jkid as ProductID, jkcat as PackageID, activeDiscount as Discount, isStock as WhenHasStorage
