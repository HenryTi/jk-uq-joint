...
class OpenApi extends fetch_1.Fetch {
    ...
    async loadTuidValue(tuidName, divName, id, ownerId, allProps) {
        let ret = await this.post(`open/tuid-value/${tuidName}/${divName}`, { unit: this.unit, id: id, ownerId: ownerId, all: allProps });
        return ret;
    }
